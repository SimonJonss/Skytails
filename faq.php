...
<body class="bg-color-my">
    ...
    <div class="row" id="contentMainDiv">
                <div class="col-md-6">
                    <br><br>
                    <div class="my-column-content" id="faq_column1">
                        <!-- the start of faq box -->
                        <div class="faq_div">
                            <div class="faq_question">Vad är 5 plus fem?</div><!-- faq question end -->
                            <div class="faq_awnser">Hejsan</div><!-- faq awnser end -->
                        </div><br><br>
                        <!-- the end of faq box -->
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="my-column-content" id="faq_column2">
